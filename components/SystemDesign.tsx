  ...
  <section className="bg-white dark:bg-gray-900">
            ...
            <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Application <span className='text-blue-500'>Requirements</span></h1>
              ...
              <div className="mt-8 space-y-5">
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  ...
                  <span className="mx-2">User Interface (Next and Typescript)</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Authentication Service (Firebase Authentication)</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Backend API Server</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Messaging Service</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Language Translation Service (Google Cloud Translation AI)</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Payment Gateway Integration (Stripe)</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Cloud Storage (Firebase Storage)</span>
                </p>
                <p className="flex items-center -mx-2 text-gray-700 dark:text-gray-200">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 mx-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="mx-2">Deployment Service (Vercel)</span>
                </p>
    ...
    <div className="container mx-8 space-y-8 lg:space-y-0 flex flex-col-reverse lg:flex-row">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Application <span className='text-blue-500'>Workflow</span></h1>
            ...
            <p className="my-4 text-gray-500 dark:text-gray-300 md:text-md">
       ...
       Final High Level <span className='text-blue-500'>Design</span>
        ...
        />
          <div className="mt-6 lg:w-1/2 lg:mt-0 lg:mx-6 ">
            ...
            <ul style={listStyle}>
            <li className='text-gray-500 dark:text-gray-300 md:text-md'>
...
<section className="bg-white dark:bg-gray-900">
      <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
        ...
        <div className="inline-flex w-full mt-6 sm:w-auto">
          <a
            href="https://www.geeksforgeeks.org/software-engineering-user-interface-design/"
            className="inline-flex items-center justify-center w-full px-6 py-2 text-white duration-300 bg-blue-600 rounded-lg hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80"
          >
            Learn More
          </a>
    ...
    {/* <div className="mt-8 lg:w-full lg:mt-0 lg:px-6">
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container flex flex-col items-center px-4 py-12 mx-auto text-center">
          ...
          <div className="inline-flex w-full mt-6 sm:w-auto">
            <a
              href="https://medium.com/inside-ppl-b7/four-main-keys-of-persona-in-software-development-d4df627aeb96"
              className="inline-flex items-center justify-center w-full px-6 py-2 text-white duration-300 bg-blue-600 rounded-lg hover:bg-blue-500 focus:ring focus:ring-blue-300 focus:ring-opacity-80"
              target='_blank'
            >
              Learn More
    ...
    <div className="lg:flex lg:-mx-6">
      ...
      <div className="mt-8 lg:w-1/2 lg:mt-0 lg:px-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">User Interaction and Input</h1> <br/>
            <li className=' text-gray-500 dark:text-gray-300'>Encompasses the initial interaction where users register and input information such as usernames, emails, and preferences.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Includes the subscription model, allowing users to choose between free and paid plans based on their communication needs.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Involves real-time messaging, enabling users to communicate in their preferred language without the worry of a language barrier.</li>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="lg:flex lg:-mx-6">
      ...
      <div className="mt-8 lg:w-1/2 lg:mt-0 lg:px-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Translation and Processing.</h1> <br/>
            <li className=' text-gray-500 dark:text-gray-300'>Utilizes Google Cloud AI services for real-time translation of messages.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Messages are initially stored in Firebase Firestore, ensuring secure and reliable storage.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Involves the processing of stored messages, converting them into the preferred language of the receiver.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Ensures secure transmission of the translated messages, providing a seamless and efficient user experience.</li>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="lg:flex lg:-mx-6">
      ...
      <div className="mt-8 lg:w-1/2 lg:mt-0 lg:px-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Secure Transmission and User Interface</h1> <br/>
            <li className=' text-gray-500 dark:text-gray-300'>Integrates APIs for translation services and other functionalities.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Presents translated messages in the user interface, maintaining a user-friendly experience.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Includes user interactions, profile updates, and robust security measures for authentication and data protection.</li>
            <li className=' text-gray-500 dark:text-gray-300'>Upholds the subscription model, distinguishing between free and paid plans, to offer users a tailored experience based on their communication needs.</li>
        </div>
      </div>
