...
import chatpic from '../images/customchatimage/chatpic.gif'
import Blob from '@/components/Blob'
import Image from 'next/image';
import phone1234 from '../images/customchatimage/phone1234.png'
...
Start using our app today. */}
                  <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Boost your productivity <br /> Start using our app today</h1>
                  <div className="mt-2">
                ...
                <div className="md:flex md:items-start md:-mx-4">
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    {/* Lag-Free Experience  Enjoy instant communication like never before with our app's lightning-fast messaging system. Say goodbye to delays and lag, and experience real-time conversations with zero latency. */}
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Two-Way Translation</h1>
                ...
                <div className="md:flex md:items-start md:-mx-4">
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Lag-Free Experience </h1>
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
                    Enjoy instant communication like never before with our app&apos;s lightning-fast messaging system. Say goodbye to delays and lag, and experience real-time conversations with zero latency.
                    </p>
                  </div>
                </div>
                <div className="md:flex md:items-start md:-mx-4">
                  ...
                  <div className="mt-4 md:mx-4 md:mt-0">
                    <h1 className="text-xl font-semibold text-gray-700 capitalize dark:text-white">Private Group Sessions</h1>
                    <p className="mt-3 text-gray-500 dark:text-gray-300">
              ...
              <Image
                className="w-[28rem] h-[28rem] xl:w-[30rem] xl:h-[34rem] rounded-full rounded-xl"
                src={phones.src}
                alt=""
                width={1000} // Set the width as needed
            ...
            <div>     
                <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white pt-40">Clients Using Our Solutions</h1>
                <div className="mt-2">
                <span className="inline-block w-40 h-1 bg-blue-500 rounded-full" />
                <span className="inline-block w-3 h-1 ml-1 bg-blue-500 rounded-full" />
                <span className="inline-block w-1 h-1 ml-1 bg-blue-500 rounded-full" />
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-6 lg:grid-cols-5">
              ...
              <div className="flex items-center justify-center col-span-1 md:col-span-2 lg:col-span-1 pt-40 pb-20">
              ...
              <div className="flex items-center justify-center col-span-1 md:col-span-3 lg:col-span-1 pt-40 pb-20">
              ...
              <div className="flex items-center justify-center col-span-2 md:col-span-3 lg:col-span-1 pt-40 pb-20">
