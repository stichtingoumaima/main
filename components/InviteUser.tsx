    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        if (!isPro && noOfUsersInChat >= 2) {
            toast({
                ...
                description: "You have exceeded the limit of uses in a single chat for the FREE plan. Please upgrade to PRO to continue adding usees to the chats!",
                variant: "destructive",
                action: (
                    <ToastAction
                        altText="Upgrade"
        ...
        if (querySnapshot.empty) {
            ...
            await setDoc(addChatRef(chatId, user.id), {
                ...
                .catch(() => {
                    toast({
                        title: "Error",
                        description: "Whooops... there was an error adding the user to the chat!",
                        variant: "destructive",
                    });
