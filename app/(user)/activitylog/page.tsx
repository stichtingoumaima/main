...
const ActivityLogs = () => {
  ...
  return (
    <div className="flex justify-center items-start pt-24 backdrop-blur-sm bg-opacity-50" style={{height: 'calc(100vh - 96px)'}}>
      <div className="w-1/3 text-white p-2 shadow-xl">
      ...
      <div className="flex-1 max-w-4xl bg-[#F5F2EB] shadow-xl ml-8 p-5 text-gray-700 overflow-auto" style={{ maxHeight: 'calc(90vh - 96px)' }}>
          ...
          {activityLogsData.map((log, index) => (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 bg-[#44516A] hover:bg-[#2B3848] text-white font-bold text-sm transition-colors self-start md:self-center"
              >
                Claim
              </motion.button>
